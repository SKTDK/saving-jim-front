...
class _HabitItemSummaryState extends State<HabitItemSummary> {
  ...
  Widget build(BuildContext context) {
    ...
    final numeroWidget = Expanded(
      child: Text((widget.number+1).toString(), textAlign: TextAlign.center)
    );

    final nameWidget = Expanded(
      child: Text(widget.habit.name, textAlign: TextAlign.center)
    );
    ...
    final likeOrNotWidget = Expanded(
      child: SizedBox( 
        ...
        child: Row(
          children: <Widget>[
            Expanded( 
              child: _giveIconIfTrue(widget.habit.likedOrNot, 'assets/img/labels/smilingheart.png')
            ),
            Expanded( 
              child: _giveIconIfFalse(widget.habit.likedOrNot, 'assets/img/labels/sadheart.png')
            )
          ],
        )
      )
    ...
    final needHelpOrNotWidget = Expanded(
      child: SizedBox( 
        ...
        child: Row(
          children: <Widget>[
            Expanded( 
              child: _giveIconIfTrue(widget.habit.needHelpOrNot, 'assets/img/labels/needhelp.png')
            ),
            Expanded( 
              child: _giveIconIfFalse(widget.habit.needHelpOrNot, 'assets/img/labels/noneedhelp.png')
            )
          ],
        )
      )
    ...
    final satisfiedOrNotWidget = Expanded(
      child: SizedBox( 
        ...
        child: Row(
          children: <Widget>[
            Expanded( 
              child: _giveIconIfTrue(widget.habit.satisfiedOrNot, 'assets/img/labels/happyface.png')
            ),
            Expanded( 
              child: _giveIconIfFalse(widget.habit.satisfiedOrNot, 'assets/img/labels/sadface.png')
            )
          ],
        )
      )
